...
public final class Constants {
    ...
    public static final int FRONT_LEFT_MODULE_STEER_ENCODER = 21; // Set front left steer encoder ID
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(22.5); // Measure and set front left steer offset

    public static final int FRONT_RIGHT_MODULE_DRIVE_MOTOR = 3; // Set front right drive motor ID
    public static final int FRONT_RIGHT_MODULE_STEER_MOTOR = 4; // Set front right steer motor ID
    ...
    public static final int BACK_RIGHT_MODULE_STEER_ENCODER = 24; // Set back right steer encoder ID
